...
INSERT INTO `subcategory` (`subCatID`, `subCategory`) VALUES
(1, 'Coffee'),
(2, 'Coffee beans'),
(3, 'Coffee machine');
...
CREATE TABLE `subscription` (
  ...
  `subCategoryIDs` varchar(50) NOT NULL,
...
INSERT INTO `subscription` (`subID`, `email`, `subCategoryIDs`, `subDate`, `subStatus`) VALUES
(1, 'test@test.com', '1,2,', '2024-07-12 08:57:58', 'active'),
(8, 'test2@test.com', '%', '2024-07-12 01:09:07', 'active'),
(12, 'test3@test.com', '1,2,', '2024-07-13 01:53:14', 'active'),
(13, 'test4@test.com', '1,3,', '2024-07-14 12:30:53', 'active');
